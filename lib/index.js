...
const logger = runtime_1.Logger.getLogger('plugin:InfluxdbMetricPlugin');
class InfluxdbMetricPlugin extends runtime_1.Plugin {
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            router.post('/influxdb/:space', (req, res) => __awaiter(this, void 0, void 0, function* () {
                res.send({
                    key
                });
            }));
            ...
            clustermgr.addMetricDriver('influxdb', metric_1.InfluxdbMetricDriver);
        });
    }
    deactivate() {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = InfluxdbMetricPlugin;
